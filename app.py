...
from config import (
    log, DATABASE_URL, BOT_TOKEN, BOT_USERNAME, ADMIN_PASSWORD, ADMIN_CHAT_ID,
    REVIEW_COOLDOWN, REQUEST_COOLDOWN, TMDB_TOKEN, TMDB_KEY, PORT, BASE_URL,
    SECRET_KEY, FX_DEFAULTS,
)
